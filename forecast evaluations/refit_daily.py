...
OUT_PREDS_PATH = "../data/lstm_rolling_oos_predictions_refit3.csv" # saving predictions 
OUT_RMSE_PATH = "../data/lstm_rolling_oos_rmse_refit3.csv" # save rmse results 
...
REFIT_EVERY = 3        # set to 7 = weekly refit (compute-friendly)
